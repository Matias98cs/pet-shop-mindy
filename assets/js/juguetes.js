//querySelector
const contenedorJuguete = document.querySelector("#containerJuguetes");
...
const getData = async () => {
    ...
    pintarProductos(filtrosJuguete(data.response), contenedorJuguete);
    pintarLiquidacion(filtrarStock(filtrosJuguete(data.response)), liquidacion)
};

getData();

function filtrosJuguete(array) {
    let Juguete = array.filter((producto) => producto.tipo === "Juguete");
    return Juguete;
}
